...
//get the last draw count, after that read every draw count from 1 to current draw count.  Then
		//if the destination is a community, get how many cards are in the community hand
		// do geticardnmbr then call BuildImage using that number
		// if the destination is a player, check if that player is you or the other player
		// if it is you make it so it is viable.  If it is not you check the visablity and 
		// change it accordingly.  Do this for both players.  If it is not visable 
		// build card image based off of card back
